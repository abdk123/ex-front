  ...
  implements OnInit, AfterViewInit
{
  ...
  // initialRowValue(index: number , incomeTransferDetail: IncomeTransferDetailDto){
  //   // currency
  //   let currencyId = 'currency' + index; 
  //   let currencyEle = getInstance(document.getElementById(currencyId), DropDownList) as DropDownList;
  //   currencyEle.value = incomeTransferDetail.currencyId;
  //   //currency.refresh();

  //   //amount
  //   let amountId = 'amount' + index; 
  //   let amountEle = getInstance(document.getElementById(amountId), NumericTextBox) as NumericTextBox;
  //   amountEle.value = incomeTransferDetail.amount;
    
  //   //commission
  //   let commissionId = 'commission' + index; 
  //   let commissionEle = getInstance(document.getElementById(commissionId), NumericTextBox) as NumericTextBox;
  //   commissionEle.value = incomeTransferDetail.commission;

  //   //sender
  //   let senderDto = this.customers.find(x=>x.id == incomeTransferDetail.senderId);
  //   let senderId = 'sender' + index; 
  //   let senderEle = getInstance(document.getElementById(senderId), AutoComplete) as AutoComplete;
  //   senderEle.value = senderDto?.name;

  //   //sender phone
  //   let senderPhoneId = 'senderPhone' + index; 
  //   let senderPhoneEle = document.getElementById(senderPhoneId) as HTMLInputElement;
  //   senderPhoneEle.value = senderDto?.phoneNumber;

  //   // payment type
  //   let paymentTypeId = 'paymentType' + index; 
  //   let paymentTypeEle = getInstance(document.getElementById(paymentTypeId), DropDownList) as DropDownList;
  //   paymentTypeEle.value = incomeTransferDetail.paymentType;
    
    
  //   if(incomeTransferDetail.paymentType == 0 || incomeTransferDetail.paymentType == 2){
  //     //beneficiary
  //     let beneficiaryDto = this.customers.find(x=>x.id == incomeTransferDetail.beneficiaryId);
  //     let beneficiaryId = 'beneficiary' + index; 
  //     let beneficiaryEle = getInstance(document.getElementById(beneficiaryId), AutoComplete) as AutoComplete;
  //     beneficiaryEle.value = beneficiaryDto?.name;

  //     //beneficiary phone
  //     let beneficiaryPhoneId = 'beneficiaryPhone' + index; 
  //     let beneficiaryPhoneEle = document.getElementById(beneficiaryPhoneId) as HTMLInputElement;
  //     beneficiaryPhoneEle.value = beneficiaryDto?.phoneNumber;
  //   }
  ...
  //     // to client
  //     let toClientId = 'toClient' + index; 
  //     let ss = document.getElementById(toClientId);
  //     let toClientEle = getInstance(document.getElementById(toClientId), DropDownList) as DropDownList;
  //     toClientEle.value = incomeTransferDetail.toClientId;

  //     // client commission
  //     let clientCommissionId = 'clientCommission' + index; 
  //     let clientCommissionEle = getInstance(document.getElementById(clientCommissionId), NumericTextBox) as NumericTextBox;
  //     clientCommissionEle.value = incomeTransferDetail.clientCommission;
  //   }
  ...
  //     let toCompanyId = 'toCompany' + index; 
  //     let toCompany = getInstance(document.getElementById(toCompanyId), DropDownList) as DropDownList;
  //     toCompany.value = incomeTransferDetail.toCompanyId;
      
  //     // company commission
  //     let companyCommissionId = 'companyCommission' + index; 
  //     let companyCommissionEle = getInstance(document.getElementById(companyCommissionId), NumericTextBox) as NumericTextBox;
  //     companyCommissionEle.value = incomeTransferDetail.companyCommission;
  //   }
  // }
